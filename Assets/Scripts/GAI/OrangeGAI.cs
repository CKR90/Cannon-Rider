...
public class OrangeGAI : MonoBehaviour, I_Enemy, I_Destroy
{
    ...
    {
        if (EnemyName == "Banana") DailyMissionDatabase.AddDailyData(DailyItem.Banana, gunType, 1);
        if (EnemyName == "Orange") DailyMissionDatabase.AddDailyData(DailyItem.Orange, gunType, 1);
